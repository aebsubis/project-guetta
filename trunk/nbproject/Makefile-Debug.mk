...
LDLIBSOPTIONS=`pkg-config --libs pcl_io-1.1` `pkg-config --libs pcl_features-1.1` `pkg-config --libs pcl_common-1.1`  
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/project-guetta
